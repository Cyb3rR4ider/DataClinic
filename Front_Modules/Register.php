    ...
    <div class="row">
      <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
        <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
          ...
          <!-- <img class="img-fluid rounded mx-auto my-4" loading="lazy" src="././doctorback.png" width="100%" height="100vh" alt="BootstrapBrain Logo"> -->
        ...
        <div class="p-3 p-md-4 p-xl-5">
          ...
          <form action="" method="post">
            <div class="row gy-3 gy-md-4 overflow-hidden">
              ...
              <div class="col-12">
                <div class="d-grid">
                  <button class="btn bsb-btn-xl btn-primary" name="sub-btn" type="submit">Sign up</button>
                </div>
              </div>
            </div>
          </form>
          <div class="row">
            <div class="col-12">
              ...
              <p class="m-0 text-secondary text-end">Already have an account? <a href="index.php" class="link-primary text-decoration-none">Sign in</a></p>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
...
<?php } else {
  ...
  $userforlogin->insertUser($username,$pass,$email,$phone,$roleid);
