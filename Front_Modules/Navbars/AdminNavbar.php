<nav class="navbar navbar-expand-lg navbar-light " style="background-color: var(--rich-black-fogra-29);;" id="usernavbar">
  <a class="navbar-brand" href="index.php" style="font-family: crimson;">  
  <img src="assets/images/logo.png" width="186" height="76" alt="dataclinic-logo" class="navbar-logo">
  </a>
