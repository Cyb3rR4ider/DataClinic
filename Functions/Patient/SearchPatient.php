<div class="form-outline mb-4" data-mdb-input-init>
  <input type="search" class="form-control" placeholder="ΑΝΑΖΗΤΗΣΗ ΑΣΘΕΝΗ" id="datatable-search-input">
</div>
<div id="datatable">
</div>
         ...
         //   $("#usernavbar").css("display", "none"); 
            ...
            if (input != "") { //if input is not empty then we use ajax method
                $.ajax({ 
                    ...
                    url: "Functions/Patient/PatientSearchResult.php",  // we redirect in this file
                    method: "POST",
                    data: {
